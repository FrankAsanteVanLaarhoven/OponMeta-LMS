...
import FlutterwavePaymentForm from './FlutterwavePaymentForm';
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-700">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-300">40-50 hours</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Users className="w-4 h-4 text-gray-400" />
                      <span className="text-sm text-gray-300">0 students enrolled</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Star className="w-4 h-4 text-gray-400" />
                      <span className="text-sm text-gray-300">0 rating</span>
                    </div>
                    <div className="flex items-center space-x-2">
                          ...
                          <SelectItem key={code} value={code} className="text-white hover:bg-gray-700">
                            <div className="flex items-center space-x-2">
                              ...
                              <Badge variant="outline" className="text-xs">
                                {PAYMENT_GATEWAYS[config.gateway].name}
                              </Badge>
                            </div>
                          </SelectItem>
                        ))}
