...
const features: Feature[] = [
  ...
  { id: "mentorship-programs", title: "Personalized Mentorship Programs", description: "Grow faster with support from experienced mentors.", icon: Users, iconColor: "text-indigo-400", category: "Collaborative Learning Environment" },
  { id: "corporate-partnerships", title: "Industry Training Partnerships", description: "Earn certifications and join specialized programs with top organizations.", icon: Building, iconColor: "text-gray-400", category: "Industry-Relevant Training" },
  { id: "hands-on-training", title: "Real-World Training Programs", description: "Develop skills through real-world simulations and scenarios.", icon: Target, iconColor: "text-orange-400", category: "Industry-Relevant Training" },
  ...
  { id: "career-coaching", title: "Career Coaching & Guidance", description: "Get personalized coaching and support for your career journey.", icon: MessageSquare, iconColor: "text-pink-400", category: "Professional Growth & Leadership Development" },
  ...
  { id: "cultural-programs", title: "Culturally Responsive Programs", description: "Specialized training for diverse backgrounds and regions.", icon: Users, iconColor: "text-emerald-400", category: "Inclusivity & Diversity in Learning" },
  ...
  { id: "ambassador-programs", title: "Global Ambassador Programs", description: "Represent our brand and connect with a global community.", icon: Users, iconColor: "text-orange-600", category: "Community-Driven Marketing" },
