...
import { 
  BookOpen, Users, DollarSign, BarChart3, Plus, ArrowRight, Star, TrendingUp, Download,
  Clock, Award, ChevronDown, Search, Bell, Folders, Route, Library, Settings, 
  Gamepad2, CalendarDays, Trash, Sparkles, MoreHorizontal
} from "lucide-react";
...
const Overview = () => {
  ...
  const quickActions = [
    ...
    { icon: CalendarDays, label: "Training Calendar", description: "Schedule training" },
