      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-purple-900 hover:bg-gray-100" onClick={() => navigate("/signup")}>
              Create Free Account
            </Button>
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10" onClick={() => navigate("/courses")}>
              Browse All Courses
            </Button>
          </div>
        </div>
                ...
                <CardContent className="p-0">
                  <div className="relative">
                    ...
                    <div className="absolute top-2 left-2">
                      <Badge className="bg-green-500/90 text-white">{course.price}</Badge>
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-blue-200 text-sm mb-3">by {course.instructor}</p>
